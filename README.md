...
## Sampling
(7) Create a folder named `scale_8` under `/root/autodl-tmp` and put the model `ema_0.9999_100000.pt` under `scale_8` since the sampling process only involves `ema_0.9999_100000.pt`
